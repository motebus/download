...
ebb06ea3ceb3e31d63abd5174f6254f16afd0540a5c41a59ac6866f8c078fc2e  medge-core_1.0.0-3_all.deb
...
4ca4df2fe829be1d5328e44622123dabcab9656556385e7119199315f55c2bf7  medge-all_1.0.0-3_all.deb
EOF
(
    cd "$PACKAGE_DIR"
...
for package_spec in \
    ...
    "medge-core:1.0.0-3:medge-core_1.0.0-3_all.deb" \
    "mdesk:3.0.0-2:mdesk_3.0.0-2_amd64.deb" \
    "ss-webos:2.0.0-8:ss-webos_2.0.0-8_amd64.deb" \
    "cx-node:0.3.1-7:cx-node_0.3.1-7_amd64.deb" \
    "medge-all:1.0.0-3:medge-all_1.0.0-3_all.deb"; do
...
dpkg-query -W -f='${Package}=${Version}\n' \
    sphere moted medge mote-proxy motemcp medge-core mdesk ss-webos cx-node medge-all
