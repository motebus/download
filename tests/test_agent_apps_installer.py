...
class AgentAppsInstallerTest(unittest.TestCase):
    ...
    def test_snapshot_matches_the_reviewed_native_release(self) -> None:
        ...
        self.assertEqual(record["repository"], "motebus/download")
        self.assertEqual(record["tag"], "v0.3.0-47")
        self.assertEqual(record["source_commit"], "07a4a449db1d5b50d3367a1c495c7b8ddb7b0f82")
        self.assertEqual(record["sha256"],
                         "0b755a74b575ba332e4aa56e53056aa9316d7c928b811b01c9765677e892498b")
