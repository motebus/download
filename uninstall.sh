...
POLICY = {'agent-sphere': {'version': '0.2.0-11',
                  'architecture': 'all',
                  'sha256': 'aed360ca2ea17e5073482c99e347e4ae10a54a74d289aba44d179c02f68c84fe',
 ...
 'mote-mcp-ultra': {'version': '0.1.0-1',
                    ...
                    'units': [],
                    'retained_payloads': []},
 'cx-mesh': {'version': '1.2.0-1',
             'architecture': 'amd64',
             'sha256': 'caa078bdd810580dc8b35380d2fe8abbda6ff6c4338f2a8c8dbbba3051d02af0',
             'hooks': {'prerm': 'ebfbc4ca6b042f3322d281f208a73c2b9386788410b0d988895d82c74f546694',
                       'postrm': '1d01229f94d330318179b7ab73c092daf8b776d31082fe4a8ea03d6e19610238'},
             'units': ['cx-mesh.service'],
             'retained_payloads': ['/usr/share/cx-node/bootstrap/cx-node-mchat.env']},
 ...
 'mdesk': {'version': '3.0.0-6',
           ...
           'hooks': {'prerm': None, 'postrm': 'bfe629b242deb41d30e833a8e8800edb231ff83f0064d7baf0952e3f3cee1e86'},
 ...
 'uchatd': {'version': '0.4.0-1',
            ...
            'retained_payloads': []}}
RELEASE_TAG = 'agent-computer-v0.2.0-12'
